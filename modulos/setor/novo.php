        	...
        	<div class="row">
            	<div class="col-sm-8 b-r">
                	<form role="form" action="/setor/gravar" method="post">
                    	...
                    	<div class="form-group"><label>Nome</label><span style="color: red;"> *</span> <input type="text" required="required" value="<?php echo $obj->nome ? $obj->nome : null ?>" placeholder="Nome do setor" class="form-control" name="nome"></div>
                        <div>
