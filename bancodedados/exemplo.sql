...
--
-- Host: localhost
-- Tempo de geração: 30/11/2018 às 13:41
...
--
CREATE DATABASE IF NOT EXISTS `e2f10` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `e2f10`;
...
INSERT INTO `checklist` (`id`, `data_cadastro`, `usuario_id`, `nome`, `ativo`, `meta`) VALUES
(1, '2018-11-20 16:52:21', 3, 'Bundle PAV (este é para pacientes que estão dependentes dorespirador mecânico, ou seja está internado na UTI)', 1, 95),
(2, '2018-11-20 17:39:19', 3, 'Bundle Sonda Vesical (pacientes em uso de sonda vesical)', 1, 75);
